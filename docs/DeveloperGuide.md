...
* inherits from `AddressBookStorage`, `PropertyBookStorage`, and `UserPrefStorage`, which means it can be treated as any of the three (if only a subset of the functionality is needed).
