...
| Phone Number                | phone/  | Should only contain numbers (0-9), and it should be at least 3 digits long                                                                                                                                                                                                   |
...
| Tag                         | tag/    | Should only be these (case-insensitive): buyer, seller, tenant, landlord                                                                                                                                                                                                     |
| Minimum Budget (in SGD)     | min/    | Should be a non-negative integer. If not provided, will have a default of $0                                                                                                                                                                                                 |
| Maximum Budget (in SGD)     | max/    | Should be a non-negative integer and more than the minimum budget. If not provided, will have a default of $200,000,000,000                                                                                                                                                  |
| Notes                       | notes/  | Can take any value. Maximum of 500 characters                                                                                                                                                                                                                                |
| Contact Status              | s/      | Should only be these (case-insensitive): active, inactive                                                                                                                                                                                                                    |
| Limit                       | limit/  | Should be an integer more than 0                                                                                                                                                                                                                                             |
| Offset                      | offset/ | Should be an integer more than or equals to 0                                                                                                                                                                                                                               |
| Number of Bathrooms         | bath/   |                                                                                                                                                                                                                                                                              |
| Number of Bedrooms          | bed/    |                                                                                                                                                                                                                                                                              |
| Floor Area (metres squared) | f/      |                                                                                                                                                                                                                                                                              |
| Listing                     | l/      |                                                                                                                                                                                                                                                                              |
| Postal Code                 | postal/ |                                                                                                                                                                                                                                                                              |
