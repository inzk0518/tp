...
public class CliSyntax {
    ...
    public static final Prefix PREFIX_PROPERTY_STATUS = new Prefix(PREFIX_STATUS_RAW);
    ...
    public static final Prefix PREFIX_PROPERTY_TYPE = new Prefix(PREFIX_TAG_RAW);
