...
public class AddContactCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Contact expectedContact = new ContactBuilderUtil(BOB).withTags(VALID_TAG_FRIEND).build();
        ...
        Contact expectedContactMultipleTags = new ContactBuilderUtil(BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND)
                .build();
