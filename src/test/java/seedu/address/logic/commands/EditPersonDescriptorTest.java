...
public class EditPersonDescriptorTest {
    ...
    public void equals() {
        ...
        editedAmy = new EditPersonDescriptorBuilder(DESC_AMY).withTags(VALID_TAG_TENANT).build();
        assertNotEquals(DESC_AMY, editedAmy);
    }
    ...
    public void toStringMethod() {
        ...
        String expected = EditPersonDescriptor.class.getCanonicalName() + "{name="
                ...
                + editPersonDescriptor.getAddress().orElse(null) + ", budgetMin="
                + editPersonDescriptor.getBudgetMin().orElse(null) + ", budgetMax="
                + editPersonDescriptor.getBudgetMax().orElse(null) + ", notes="
                + editPersonDescriptor.getNotes().orElse(null) + ", status="
